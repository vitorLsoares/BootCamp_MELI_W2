...
public class Radixsort {
    ...
    public static void radixSort(int iArr[]) {
        ...
        for(int i = 0; i < sArr.length; i++) {
            sArr[i] = StringUtil.lpad(String.valueOf(iArr[i]),'0',width); //New way
        ...
        for(int x = 1; x <= width; x++) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                for (String j : listaOrdenada) {
                    ...
                    String actualDigit = StringUtil.ltrim(j); // new way
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" neste caso é = " + StringUtil.indexOfN("John | Paul | George | Ringo",'|',2)); ;
    }
